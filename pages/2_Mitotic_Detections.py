...
st.write(f"Yellow colors are detections that are classified in one of the 3 phases: ProPhase, Metaphase and Anaphase / Telophase")
st.write(f"Blue colors are detections that can't be classified in one of the above 3 phases")
...
st.subheader(f"Phases of detection in the zoomed in region. Number denotes the probability of being mitotic")
...
def plot_attributions_in_zoomed_region(detections_in_box, data_clsf_dir, class_names):
...
fig_attributions = plot_attributions_in_zoomed_region(
    detections_in_box, data_clsf_dir, class_names)
